              ...
              <div className="row">
                <div className="col">
                  <h1 className="text-center">
                    All Courses <span>({documents.length})</span>
                  </h1>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col gap-3 d-flex">
              <Link
                to="/courses"
                className="p-4 border-2 fw-bold bottomLine"
              ...
              <div className="col" key={i}>
                ...
                >
                  <div
                    ...
                    style={{ height: "260px", backgroundColor: "#edf6f9" }}
                  >
                    <div style={{ height: "100%", padding: "9px" }}>
                      <h1 className="card-title text-center">
                        {todo.courses || "Title"}
                      </h1>
                      <h4 className="card-text d-flex align-items-center">
                        <h3>Date : </h3>
                        {todo.today || "Description"}
                      </h4>
                      <h4 className="card-text d-flex align-items-center">
                        <h3>Time : </h3>
                        {todo.todayTime || "Description"}
                      </h4>
                      <h4 className="card-text d-flex align-items-center">
                        <h3>Description : </h3>
                      ...
                      <div>
                        <button
                          ...
                          onClick={() => {
                            navigate(`../editCourse1/${todo.id}`);
                          }}
                        >
                          Edit
                        </button>
                        <button
                          className="btn btn-danger px-4 py-2 ms-2"
